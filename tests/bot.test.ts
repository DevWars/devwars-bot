...
jest.mock('../src/common/bot', () => {});

describe('bot', () => {
    it('should only execute bot command if user is authorized', () => {
    ...
    it('should split arguments into array by |, spaces, or single/double quotes', () => {
